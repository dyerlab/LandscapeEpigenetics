...
```{r fig.cap="<i>Figure X:</i> Divergent msAFLP banding patterns for isoschizomers reveal the presence and absence of cytosine methylation at the target cut site."}
knitr::include_graphics("Methylation_Schematic.png")
```
